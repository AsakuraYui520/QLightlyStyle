#ifndef LIGHTLYMETRICS_H
#define LIGHTLYMETRICS_H
...
{
    // frames
    static constexpr int Frame_FrameWidth = 5;
    //static constexpr int Frame_FrameRadius = 6;
    ...
    static constexpr int TabBar_TabMinHeight = 33;
