...
namespace Lightly
{
    ...
    class Helper : public QObject
    {
        ...
        //* checkbox
        void renderCheckBox(QPainter*, const QRect&, const QPalette&, const bool isInMenu, bool sunken, const bool mouseOver, CheckBoxState state, CheckBoxState target, const bool windowActive, qreal animation = AnimationData::OpacityInvalid ) const;
        ...
        //* true if running on platform Windows
